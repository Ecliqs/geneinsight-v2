  ...
  return (
    <section className="py-24 bg-primary text-white relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        <p className="mt-8 text-primary-foreground/70 font-medium">
          Takes less than 30 minutes • No obligation • Expert-led discussion
        </p>
      </div>
      <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/2 w-[800px] h-[800px] bg-white/10 rounded-full blur-[120px]" />
    </section>
  );
}
