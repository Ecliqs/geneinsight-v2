    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        <Link href="/" className="flex items-center space-x-2">
          <div className="flex h-8 w-32 items-center justify-center rounded-lg py-2">
            {/* <Microscope className="h-5 w-5 text-primary-foreground" /> */}
            <img src="https://geneinsight.ai/wp-content/uploads/2024/06/GENEINSIGHT-LOGO-1-1024x372.png" alt="" />
          </div>
